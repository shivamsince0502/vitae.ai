...
\begin{document}
  ...
  \begin{resume_list}
    ...
    \item Maintain and enhance the company’s marketplace for sharing prefabs, themes, and connectors, ensuring 100% functionality in documentation and code while improving resource accessibility by 40%.
    ...
    \item Developing an AI-powered chatbot using LLaMA3 and MedLLaMA2 models to streamline symptom analysis, department recommendation, and appointment booking, reducing appointment booking time by 30% and improving symptom analysis accuracy by 25%.
  \end{resume_list}
  ...
  \begin{resume_list}
    ...
    \item Engineered 34 REST API endpoints using Spring, enhancing application functionality and scalability, contributing to a 25% reduction in response times and improved overall system performance.
  \end{resume_list}
  \section{Projects}
  \headingBf{Solana Wallet extension}{August 2024 - September 2024}
  \begin{resume_list}
    \item Built a Chrome extension for managing Solana (SOL) tokens, enabling seamless token transactions.  Improved management efficiency by 35%, enhancing user control over operations.
  ...
  \begin{resume_list}
    ...
    \item Constructed 14 screens and over 13 components, leveraging Formik and Yup for efficient form handling, reducing form validation time by 70% and improving overall user input accuracy.
  \end{resume_list}
